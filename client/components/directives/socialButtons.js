// angulike bower package modified to have twitter follow button too
// this is the only reason I have jQuery here
'use strict';
/*jshint ignore: start */
                  ...
                  link: function (scope, element, attrs) {
                      ...
                      function renderTweetButton() {
                          if (!scope.tweet && !watchAdded) {
                              ...
                              element.html('<a href="https://twitter.com/share" class="twitter-share-button" data-text="' + 
                                scope.tweet + '" data-url="' + (scope.tweetUrl || $location.absUrl()) + '">Tweet</a>');
                ...
                watchAdded = true;
                    ...
                    if (newValue) {
                      ...
                      unbindWatch();
                              ...
                              element.html('<a href="https://twitter.com/' + scope.twtName + '" class="twitter-follow-button" '+
                                'data-show-count="true">Follow @' + scope.twtName + '</a>');
                              $window.twttr.widgets.load(element.parent()[0]);
                          }
                      }
                  }
